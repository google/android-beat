...
class BluetoothClassicCallControlTest(base_test.BaseTestClass):
  ...
  def test_14_1_disconnect_turn_off_bt_device(self):
  ...
  def test_14_2_auto_connect_turn_on_bt_device(self) -> None:
  ...
  def test_14_12_answer_and_end_call_from_android(self) -> None:
  ...
  def test_12_14_answer_and_end_call_from_bt_device(self) -> None:
  ...
  def test_14_15_answer_call_from_bt_device_and_end_call_from_android(
      self,
  ) -> None:
  ...
  def test_14_16_reject_incoming_call_from_bt_device(self) -> None:
  ...
  def test_17_18_make_and_end_call_from_android(self) -> None:
  ...
  def test_14_18_make_call_from_android_and_end_call_from_bt_device(
      self,
  ) -> None:
  ...
  def test_14_19_audio_transfer_during_call_bt_device_to_and_from_android(
      self,
  ) -> None:
  ...
  def test_14_22_turn_on_hf_during_active_call_from_bt_device(self) -> None:
    """Tests Bluetooth Hands-Free Profile connection when turn on headset.
  ...
  def test_14_23_turn_off_hf_during_active_call_from_bt_device(self) -> None:
  ...
  def test_14_21_turn_off_hf_BT_during_active_call(self) -> None:
