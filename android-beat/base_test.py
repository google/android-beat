...
from android-beat import bluetooth_utils
from android-beat.platforms.bluetooth import bluetooth_reference_device
from android-beat.platforms.bluetooth import tws_device
...
class BaseTestClass(base_test.BaseTestClass):
  ...
  def _setup_android_device(self, ad: android_device.AndroidDevice) -> None:
    ...
    apk_path = self.user_params[self.file_tag]['bluetooth_snippets_apk'][0]
